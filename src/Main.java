public class Main {
    public static void main(String[] args) {
        ...
        while (year <= 2034) {
            ...
            year = year + 1;
            System.out.println("Год " + year + " численность населения сосотовляет " + population + " милион человек");
        ...
        for (int month3 = 0; total3 < 12_000_000; month3++) {
            ...
            for (int year2 = 1; year2 <= 108; year2++) {
            ...
            int cometYears = 0;
            for (cometYears = yearEarlier; cometYears <= 2054; cometYears++) {
                if (cometYears % 79 == 0){
